...
namespace BasicDemo_Capsule
{
    public class BasicDemo_Capsule : Demo
    {
        ...
        int size;
        public BasicDemo_Capsule(float masspass, Vector3 gravitypass,int sizepass)
        {
            this.mass = masspass;
        ...
        protected override void OnInitializePhysics()
        {
            ...
            CapsuleShape colShape = new CapsuleShape(0.5f* this.size, 1* this.size);
    ...
    static class Program
    {
        ...
        static void Main()
        {
            using (Demo demo = new BasicDemo_Capsule())
            {
