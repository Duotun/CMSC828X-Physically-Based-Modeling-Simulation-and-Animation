...
*/
public class BulletExampleRunner_Size : MonoBehaviour {
    ...
    public string[] demoNames = new string[] { "BasicDemo_Size", "BasicDemo_Cone_Size","BasicDemo_Capsule_Size","BasicDemo_Mixed_Size","BenchmarkDemo", "Box2DDemo", "BspDemo", "CcdPhysicsDemo", "CharacterDemo", "CollisionInterfaceDemo", "ConcaveConvexCastDemo", "ConcaveRaycastDemo",
    ...
    public BulletSharp.Math.Vector3 gravity;
    public float mass;

    void Start()
    {
        RunDemo("BasicDemo_Size");
    }

    void RunDemo(string nm)
    {
        if (nm.Equals("BasicDemo_Size")) {
            demo = new BasicDemo.BasicDemo();
        }
        if (nm.Equals("BasicDemo_Cone_Size"))
        {
            demo = new BasicDemo_Cone.BasicDemo_Cone();
        }
        if (nm.Equals("BasicDemo_Capsule_Size"))
        {
            demo = new BasicDemo_Capsule.BasicDemo_Capsule();
        }
        if (nm.Equals("BasicDemo_Mixed_Size"))
        {
            demo = new BasicDemo_Mixed.BasicDemo_Mixed();
        }
