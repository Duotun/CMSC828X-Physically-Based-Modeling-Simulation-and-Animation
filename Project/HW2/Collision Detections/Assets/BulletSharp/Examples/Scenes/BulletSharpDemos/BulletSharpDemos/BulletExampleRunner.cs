...
public class BulletExampleRunner : MonoBehaviour {
    ...
    public string[] demoNames = new string[] { "BasicDemo", "BasicDemo_Cone","BasicDemo_Capsule","BasicDemo_Mixed","BenchmarkDemo", "Box2DDemo", "BspDemo", "CcdPhysicsDemo", "CharacterDemo", "CollisionInterfaceDemo", "ConcaveConvexCastDemo", "ConcaveRaycastDemo",
    ...
    void RunDemo(string nm)
    {
        if (nm.Equals("BasicDemo")) {
            demo = new BasicDemo.BasicDemo(mass,gravity,size);
        }
        if (nm.Equals("BasicDemo_Cone"))
        {
            demo = new BasicDemo_Cone.BasicDemo_Cone(mass, gravity, size);
        }
        if (nm.Equals("BasicDemo_Capsule"))
        {
            demo = new BasicDemo_Capsule.BasicDemo_Capsule(mass, gravity,size);
        }
        if (nm.Equals("BasicDemo_Mixed"))
        {
            demo = new BasicDemo_Mixed.BasicDemo_Mixed(mass, gravity, size);
        }
